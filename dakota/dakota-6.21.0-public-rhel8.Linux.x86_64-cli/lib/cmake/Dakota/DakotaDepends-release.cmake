...
set_target_properties(muqUtilities PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmuqUtilities.so"
  IMPORTED_SONAME_RELEASE "libmuqUtilities.so"
  )

list(APPEND _cmake_import_check_targets muqUtilities )
list(APPEND _cmake_import_check_files_for_muqUtilities "${_IMPORT_PREFIX}/lib/libmuqUtilities.so" )
...
set_target_properties(muqModeling PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmuqModeling.so"
  IMPORTED_SONAME_RELEASE "libmuqModeling.so"
  )

list(APPEND _cmake_import_check_targets muqModeling )
list(APPEND _cmake_import_check_files_for_muqModeling "${_IMPORT_PREFIX}/lib/libmuqModeling.so" )
...
set_target_properties(muqSamplingAlgorithms PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmuqSamplingAlgorithms.so"
  IMPORTED_SONAME_RELEASE "libmuqSamplingAlgorithms.so"
  )

list(APPEND _cmake_import_check_targets muqSamplingAlgorithms )
list(APPEND _cmake_import_check_files_for_muqSamplingAlgorithms "${_IMPORT_PREFIX}/lib/libmuqSamplingAlgorithms.so" )
