/*
  $Id: cdd.h 202 2012-03-07 22:26:01Z tplante $
  $URL: https://software.sandia.gov/svn/hopspack/trunk/src/src-citizens/citizen-gss/cddlib/cdd.h $
*/
 ...
 *               Copyright (2003-2012) Sandia Corporation
 * 
...
/*---- HOPSPACK ADDS THIS FOR COMPILING ON WINDOWS.
 *---- THE CODE IS REPLICATED IN HOPSPACK_common.hpp. */
#if defined(_WIN32)
  #if (_MSC_VER >= 1400)
