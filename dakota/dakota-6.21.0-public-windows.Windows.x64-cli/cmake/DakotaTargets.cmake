...
foreach(_cmake_expected_target IN ITEMS dakota_util dakota_surrogates conmin ncsuopt nidr amplsolver optpp dfftpack lhs_mod lhs_mods lhs sparsegrid pecos_util pecos_src approxnn surfpack_interpreter surfpack surfpack_fortran 3po tinyxml utilib colin pebbl scolib interfaces ddace dream fsudace fsu_halton_standalone fsu_hammersley_standalone fsu_cvt_standalone fsu_latinize_standalone fsu_quality_standalone hopspack moga soga utilities jega_fe eutils jega cport nomad psuade dakota_src_fortran dakota_src)
...
add_library(dakota_util STATIC IMPORTED)

set_target_properties(dakota_util PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "EIGEN_MPL2_ONLY"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "teuchosremainder;teuchosnumerics;teuchoscomm;teuchosparameterlist;teuchosparser;teuchoscore;Eigen3::Eigen;\$<LINK_ONLY:Boost::boost>;Boost::serialization"
)

# Create imported target dakota_surrogates
add_library(dakota_surrogates STATIC IMPORTED)
...
set_target_properties(optpp PROPERTIES
  INTERFACE_LINK_LIBRARIES "teuchosremainder;teuchosnumerics;teuchoscomm;teuchosparameterlist;teuchosparser;teuchoscore;C:/local/lapack/3.10.1/static/lib/blas.lib;C:/local/lapack/3.10.1/static/lib/lapack.lib"
)
...
add_library(pecos_util STATIC IMPORTED)

set_target_properties(pecos_util PROPERTIES
  INTERFACE_LINK_LIBRARIES "teuchosremainder;teuchosnumerics;teuchoscomm;teuchosparameterlist;teuchosparser;teuchoscore;C:/local/lapack/3.10.1/static/lib/lapack.lib;C:/local/lapack/3.10.1/static/lib/blas.lib;Boost::boost"
)
...
set_target_properties(pecos_src PROPERTIES
  INTERFACE_LINK_LIBRARIES "pecos_util;lhs;lhs_mods;lhs_mod;dfftpack;sparsegrid;teuchosremainder;teuchosnumerics;teuchoscomm;teuchosparameterlist;teuchosparser;teuchoscore;C:/local/lapack/3.10.1/static/lib/lapack.lib;C:/local/lapack/3.10.1/static/lib/blas.lib;Boost::boost"
)

# Create imported target approxnn
add_library(approxnn STATIC IMPORTED)
...
set_target_properties(surfpack_interpreter PROPERTIES
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:Boost::boost>"
)
...
set_target_properties(utilib PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "tinyxml;dbghelp"
)
...
set_target_properties(colin PROPERTIES
  INTERFACE_LINK_LIBRARIES "tinyxml;utilib;amplsolver"
)
